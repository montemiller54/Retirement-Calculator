...
import { Toggle, Section, Field } from './shared';
  ...
  return (
    <div className="space-y-8">
      ...
      <Section
        ...
        description="How you draw down your portfolio in retirement."
      >
      ...
      <Section
        ...
        description="A 10% penalty applies to retirement account withdrawals before age 59½, with some exceptions."
      >
      ...
      <Section
        title="Tax-Bracket Conversions"
        description="Convert money from Traditional to Roth accounts during low-income years to lock in a lower tax rate."
      >
        <div className="space-y-3">
          <div className="flex items-center gap-1">
            <Toggle
          ...
          {rc.enabled && (
            <div className="space-y-3">
              ...
              {rc.strategy === 'fillBracket' ? (
                <Field label="Fill up to tax rate">
                  <select
              ...
              <div className="grid grid-cols-2 gap-4">
                <Field label="Start Age" help="Typically retirement through age 72 (before required withdrawals begin at 73).">
      ...
      {/* ── Spending Safety Rules (Guardrails) ── */}
      <Section
        title="Spending Safety Rules"
        description="Automatically reduce spending if your portfolio drops significantly, helping your money last longer."
      >
        <div className="space-y-3">
          <div className="flex items-center gap-1">
            <Toggle
          ...
          {g.enabled && (
            <div className="space-y-2">
              <p className="text-xs text-gray-500 dark:text-gray-400">If your portfolio drops from its highest value by the percentage on the left, reduce spending by the percentage on the right.</p>
