        ...
        <div className="relative shrink-0">
          ...
          {open && (
            <div
              ref={popoverRef}
              role="menu"
              className="absolute z-30 right-0 top-full mt-1 w-64 sm:w-72 max-w-[calc(100vw-1rem)] rounded-md border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 shadow-lg"
            >
              <div className="py-1">
                <button
                  role="menuitem"
