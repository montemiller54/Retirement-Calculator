...
describe('HIGH IMPACT: Earnings & Contributions', () => {
  it('#4 higher salary → higher success rate', () => {
    const low = run({ jobs: [{ id: 'test', name: 'Test Job', owner: 'primary', monthlyPay: 5000, startAge: DEFAULT_SCENARIO.currentAge, endAge: DEFAULT_SCENARIO.retirementAge, has401k: true, employerMatchRate: 0, employerMatchCapPct: 0, employerRothPct: 0 }] });
    const high = run({ jobs: [{ id: 'test', name: 'Test Job', owner: 'primary', monthlyPay: 15000, startAge: DEFAULT_SCENARIO.currentAge, endAge: DEFAULT_SCENARIO.retirementAge, has401k: true, employerMatchRate: 0, employerMatchCapPct: 0, employerRothPct: 0 }] });
  ...
  it('#8 employer match → higher success rate', () => {
    const noMatch = run({ jobs: [{ id: 'test', name: 'Test Job', owner: 'primary', monthlyPay: DEFAULT_SCENARIO.jobs[0].monthlyPay, startAge: DEFAULT_SCENARIO.currentAge, endAge: DEFAULT_SCENARIO.retirementAge, has401k: true, employerMatchRate: 0, employerMatchCapPct: 0, employerRothPct: 0 }] });
    const withMatch = run({ jobs: [{ id: 'test', name: 'Test Job', owner: 'primary', monthlyPay: DEFAULT_SCENARIO.jobs[0].monthlyPay, startAge: DEFAULT_SCENARIO.currentAge, endAge: DEFAULT_SCENARIO.retirementAge, has401k: true, employerMatchRate: 1.0, employerMatchCapPct: 0.06, employerRothPct: 0 }] });
...
describe('MEDIUM IMPACT: Earnings', () => {
  ...
  it('#9 higher employer match cap → higher median ending', () => {
    const lowCap = run({ jobs: [{ id: 'test', name: 'Test Job', owner: 'primary', monthlyPay: DEFAULT_SCENARIO.jobs[0].monthlyPay, startAge: DEFAULT_SCENARIO.currentAge, endAge: DEFAULT_SCENARIO.retirementAge, has401k: true, employerMatchRate: 1.0, employerMatchCapPct: 0.03, employerRothPct: 0 }] });
    const highCap = run({ jobs: [{ id: 'test', name: 'Test Job', owner: 'primary', monthlyPay: DEFAULT_SCENARIO.jobs[0].monthlyPay, startAge: DEFAULT_SCENARIO.currentAge, endAge: DEFAULT_SCENARIO.retirementAge, has401k: true, employerMatchRate: 1.0, employerMatchCapPct: 0.10, employerRothPct: 0 }] });
...
describe('MEDIUM IMPACT: Contribution Limits', () => {
  it('#11 higher 401k limit → less taxable spillover → higher median ending', () => {
    ...
    const base: Partial<ScenarioInput> = {
      jobs: [{ id: 'test', name: 'Test Job', owner: 'primary', monthlyPay: 15000, startAge: DEFAULT_SCENARIO.currentAge, endAge: DEFAULT_SCENARIO.retirementAge, has401k: true, employerMatchRate: 0, employerMatchCapPct: 0, employerRothPct: 0 }],
